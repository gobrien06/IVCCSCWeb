...
import { Button, ButtonToggle, Modal, ModalHeader, ModalBody, Row, Col} from 'reactstrap';
    ...
    return(
      ...
      <Row>
        ...
        <Col lg="10">
          ...
          <Row>
            <Col xs="1">
            <ButtonToggle color="danger" size="md" className="like">♥</ButtonToggle>
            </Col>
            <Col xs="1">
            <Button color="primary" size="md" className="reply">Reply</Button>
            </Col>
          </Row>
        </Col>
      </Row>
